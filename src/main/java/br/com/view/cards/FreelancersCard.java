...
import br.com.view.forms.create.FreelancerForm;
import br.com.view.forms.update.FreelancerUpdateForm;
...
public class FreelancersCard extends JPanel implements ActionListener {
    ...
    public void actionPerformed(ActionEvent click) {
        ...
        if(click.getSource() == editButton) {
            if(validateSelectedRow()) {
                new FreelancerUpdateForm(controller, getSelectedRow(), refreshButton);
            }
        }
    ...
    private void handleRemove() {
        ...
        int confirm = JOptionPane.showConfirmDialog(
                this,
                "Deseja realmente remover este freelancer ? está ação não poderá ser desfeita.",
                "Confirmar exclusão",
        ...
        boolean success = controller.deleteFreelancer(id);

        if (success) {
            refreshButton.doClick();
            JOptionPane.showMessageDialog(this, "Freelancer removido com sucesso");
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao remover freelancer", "Erro", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private String[] getSelectedRow() {
        ...
        row[3] = table.getValueAt(table.getSelectedRow(), 4).toString();
        return row;
    }
